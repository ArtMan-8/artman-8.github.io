export default [
  ...
  },
  {
    ...
    description:
      "Реализовал одностроничник на чистом JS, с использованием патерна MVP. В разметке использовал BEM-нейминг. Стили писал на SCSS. Набросок дизайн выполнил в Figma. За основу взял цветовую гамму с официального сайта студии. Реализовал автодеплой на gh-pages с использованием travis-CI. Для данных использовал публичное REST API с информацией о аниме студии Ghibli.",
